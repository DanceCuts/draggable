...
var _distance = __webpack_require__(207);
...
var _touchCoords = __webpack_require__(209);
...
var _SensorEvent = __webpack_require__(211);
...
var _Sensors = __webpack_require__(63);
...
var _Draggable = __webpack_require__(244);
...
var _TouchSensor = __webpack_require__(212);
...
var _DragSensor = __webpack_require__(214);
...
var _ForceTouchSensor = __webpack_require__(216);
...
var _getOwnPropertyDescriptor = __webpack_require__(253);
...
module.exports = !__webpack_require__(11) && !__webpack_require__(32)(function () {
...
var _CollidableEvent = __webpack_require__(220);
...
var _SnappableEvent = __webpack_require__(225);
...
var _DragEvent = __webpack_require__(231);
...
var _DraggableEvent = __webpack_require__(232);
...
var _Announcement = __webpack_require__(233);
...
var _Focusable = __webpack_require__(235);
...
var _Mirror = __webpack_require__(237);
...
var _Scrollable = __webpack_require__(242);
...
var _DroppableEvent = __webpack_require__(248);
...
var _SwappableEvent = __webpack_require__(257);
...
var _SortableEvent = __webpack_require__(260);
...
var _Plugins = __webpack_require__(218);

var Plugins = _interopRequireWildcard(_Plugins);

var _Draggable = __webpack_require__(51);

var _Draggable2 = _interopRequireDefault(_Draggable);

var _Droppable = __webpack_require__(247);

var _Droppable2 = _interopRequireDefault(_Droppable);

var _Swappable = __webpack_require__(256);

var _Swappable2 = _interopRequireDefault(_Swappable);

var _Sortable = __webpack_require__(259);
...
function calcDelay(optionsDelay) {
  ...
  if (optionsDelay === undefined) {
    return Object.assign({}, defaultDealy);
  }

  if (typeof optionsDelay === 'number') {
    for (var key in defaultDealy) {
  ...
  for (var _key3 in defaultDealy) {
    if (defaultDealy.hasOwnProperty(_key3)) {
      if (optionsDelay[_key3] === undefined) {
        delay[_key3] = defaultDealy[_key3];
      } else {
...
var MouseSensor = function (_Sensor) {
  ...
  function MouseSensor() {
    ...
    _this[onDistanceChange] = _this[onDistanceChange].bind(_this);
    return _this;
  }
  ...
  (0, _createClass3.default)(MouseSensor, [{
    ...
    value: function value(event) {
      ...
      if (this.options.handle && event.target && !(0, _utils.closest)(event.target, this.options.handle)) {
        return;
      }

      var originalSource = (0, _utils.closest)(event.target, this.options.draggable);
      ...
      this.mouseDownTimeout = window.setTimeout(function () {
        _this2[onDistanceChange]({ pageX: _this2.pageX, pageY: _this2.pageY });
      }, delay.mouse);
    }
    ...
    value: function value(event) {
      ...
      var distanceTravelled = (0, _utils.distance)(startEvent.pageX, startEvent.pageY, pageX, pageY) || 0;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(61)(Function.call, __webpack_require__(76).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _distance = __webpack_require__(208);
...
var _touchCoords = __webpack_require__(210);
...
var _TouchSensor = __webpack_require__(213);
...
var TouchSensor = function (_Sensor) {
  ...
  (0, _createClass3.default)(TouchSensor, [{
    ...
    value: function value(event) {
      ...
      var _options$distance = this.options.distance,
          distance = _options$distance === undefined ? 0 : _options$distance;
      var delay = this.delay;

      var _touchCoords = (0, _utils.touchCoords)(event),
      ...
      this.tapTimeout = window.setTimeout(function () {
        _this2[onDistanceChange]({ touches: [{ pageX: _this2.pageX, pageY: _this2.pageY }] });
      }, delay.touch);
    }
    ...
    value: function value() {
      var startEvent = this.startEvent;
      var container = this.currentContainer;
      var touch = (0, _utils.touchCoords)(startEvent);
      var originalSource = this.originalSource;
    ...
    value: function value(event) {
      ...
      var start = (0, _utils.touchCoords)(startEvent);
      var current = (0, _utils.touchCoords)(event);
      var timeElapsed = Date.now() - this.onTouchStartAt;
      var distanceTravelled = (0, _utils.distance)(start.pageX, start.pageY, current.pageX, current.pageY);
    ...
    value: function value(event) {
      ...
      var _touchCoords2 = (0, _utils.touchCoords)(event),
    ...
    value: function value(event) {
      ...
      var _touchCoords3 = (0, _utils.touchCoords)(event),
...
var _DragSensor = __webpack_require__(215);
...
var DragSensor = function (_Sensor) {
  ...
  (0, _createClass3.default)(DragSensor, [{
    ...
    value: function value(event) {
      ...
      this.currentContainer = (0, _utils.closest)(target, this.containers);
      ...
      var originalSource = (0, _utils.closest)(target, this.options.draggable);
...
var _ForceTouchSensor = __webpack_require__(217);
...
var _Collidable = __webpack_require__(219);
...
var _ResizeMirror = __webpack_require__(222);
...
var _Snappable = __webpack_require__(224);
...
var _SwapAnimation = __webpack_require__(227);
...
var _SortAnimation = __webpack_require__(229);
...
var _Collidable = __webpack_require__(221);
...
var _ResizeMirror = __webpack_require__(223);
...
var _Snappable = __webpack_require__(226);
...
var Snappable = function (_AbstractPlugin) {
  ...
  (0, _createClass3.default)(Snappable, [{
    ...
    value: function value(event) {
      ...
      (_source$classList = source.classList).remove.apply(_source$classList, (0, _toConsumableArray3.default)(this.draggable.getClassNamesFor('source:dragging')));
      (_source$classList2 = source.classList).add.apply(_source$classList2, (0, _toConsumableArray3.default)(this.draggable.getClassNamesFor('source:placed')));

      // Need to cancel this in drag out
      setTimeout(function () {
        var _source$classList3;

        (_source$classList3 = source.classList).remove.apply(_source$classList3, (0, _toConsumableArray3.default)(_this2.draggable.getClassNamesFor('source:placed')));
    ...
    value: function value(event) {
      ...
      (_source$classList4 = source.classList).add.apply(_source$classList4, (0, _toConsumableArray3.default)(this.draggable.getClassNamesFor('source:dragging')));
    }
...
var _SwapAnimation = __webpack_require__(228);
...
var _SortAnimation = __webpack_require__(230);
...
var DragStoppedEvent = exports.DragStoppedEvent = function (_DragEvent9) {
  (0, _inherits3.default)(DragStoppedEvent, _DragEvent9);

  function DragStoppedEvent() {
    (0, _classCallCheck3.default)(this, DragStoppedEvent);
    return (0, _possibleConstructorReturn3.default)(this, (DragStoppedEvent.__proto__ || Object.getPrototypeOf(DragStoppedEvent)).apply(this, arguments));
  }
...
var _Announcement = __webpack_require__(234);
...
var _Focusable = __webpack_require__(236);
...
var _Mirror = __webpack_require__(238);
...
var _MirrorEvent = __webpack_require__(240);
  ...
  (0, _createClass3.default)(Mirror, [{
    ...
    value: function value(dragEvent) {
      ...
      if (this.options.thresholdX || this.options.thresholdY) {
        var _lastMirrorMovedClien = this.lastMirrorMovedClient,
            lastX = _lastMirrorMovedClien.x,
            lastY = _lastMirrorMovedClien.y;
    ...
    value: function value(mirrorEvent) {
      ...
      var setState = function setState(_ref3) {
        var lastMovedX = _ref3.lastMovedX,
            ...
            args = (0, _objectWithoutProperties3.default)(_ref3, ['lastMovedX', 'lastMovedY']);

        _this3.lastMovedX = lastMovedX;
        _this3.lastMovedY = lastMovedY;

        return Object.assign({ lastMovedX: lastMovedX, lastMovedY: lastMovedY }, args);
      };
      ...
      return Promise.resolve(initialState).then(positionMirror({ raf: true })).then(setState).then(triggerMoved);
    }
...
function addMirrorClasses(_ref7) {
  var mirror = _ref7.mirror,
      ...
      args = (0, _objectWithoutProperties3.default)(_ref7, ['mirror', 'mirrorClasses']);

  return withPromise(function (resolve) {
    var _mirror$classList;

    (_mirror$classList = mirror.classList).add.apply(_mirror$classList, (0, _toConsumableArray3.default)(mirrorClasses));
    resolve(Object.assign({ mirror: mirror, mirrorClasses: mirrorClasses }, args));
  });
}
...
function positionMirror() {
  ...
  return function (_ref10) {
    var mirror = _ref10.mirror,
        ...
        args = (0, _objectWithoutProperties3.default)(_ref10, ['mirror', 'sensorEvent', 'mirrorOffset', 'initialY', 'initialX', 'scrollOffset', 'options', 'passedThreshX', 'passedThreshY', 'lastMovedX', 'lastMovedY']);
...
var _MirrorEvent = __webpack_require__(241);
...
exports.MirrorDestroyEvent = exports.MirrorMovedEvent = exports.MirrorMoveEvent = exports.MirrorAttachedEvent = exports.MirrorCreatedEvent = exports.MirrorCreateEvent = exports.MirrorEvent = undefined;
...
var MirrorMovedEvent = exports.MirrorMovedEvent = function (_MirrorEvent5) {
  (0, _inherits3.default)(MirrorMovedEvent, _MirrorEvent5);

  function MirrorMovedEvent() {
    (0, _classCallCheck3.default)(this, MirrorMovedEvent);
    return (0, _possibleConstructorReturn3.default)(this, (MirrorMovedEvent.__proto__ || Object.getPrototypeOf(MirrorMovedEvent)).apply(this, arguments));
  }

  (0, _createClass3.default)(MirrorMovedEvent, [{
    key: 'mirror',
...
var MirrorDestroyEvent = exports.MirrorDestroyEvent = function (_MirrorEvent6) {
  (0, _inherits3.default)(MirrorDestroyEvent, _MirrorEvent6);
...
var _Scrollable = __webpack_require__(243);
...
var _Emitter = __webpack_require__(245);
...
var Draggable = function () {
  ...
  function Draggable() {
    ...
    this.addSensor.apply(this, [].concat((0, _toConsumableArray3.default)(defaultSensors), (0, _toConsumableArray3.default)(this.options.sensors)));
  ...
  (0, _createClass3.default)(Draggable, [{
    ...
    key: onDragStart,
    value: function value(event) {
      var _originalSource$class,
          _source$classList,
          _sourceContainer$clas,
      ...
      if (this.lastPlacedSource && this.lastPlacedContainer) {
        var _lastPlacedSource$cla, _lastPlacedContainer$;

        clearTimeout(this.placedTimeoutID);
        (_lastPlacedSource$cla = this.lastPlacedSource.classList).remove.apply(_lastPlacedSource$cla, (0, _toConsumableArray3.default)(this.getClassNamesFor('source:placed')));
        (_lastPlacedContainer$ = this.lastPlacedContainer.classList).remove.apply(_lastPlacedContainer$, (0, _toConsumableArray3.default)(this.getClassNamesFor('container:placed')));
      }
      ...
      (_originalSource$class = this.originalSource.classList).add.apply(_originalSource$class, (0, _toConsumableArray3.default)(this.getClassNamesFor('source:original')));
      (_source$classList = this.source.classList).add.apply(_source$classList, (0, _toConsumableArray3.default)(this.getClassNamesFor('source:dragging')));
      (_sourceContainer$clas = this.sourceContainer.classList).add.apply(_sourceContainer$clas, (0, _toConsumableArray3.default)(this.getClassNamesFor('container:dragging')));
      (_document$body$classL = document.body.classList).add.apply(_document$body$classL, (0, _toConsumableArray3.default)(this.getClassNamesFor('body:dragging')));
    ...
    value: function value(event) {
      ...
      if (isLeavingDraggable) {
        ...
        (_currentOver$classLis = this.currentOver.classList).remove.apply(_currentOver$classLis, (0, _toConsumableArray3.default)(this.getClassNamesFor('draggable:over')));
      ...
      if (isLeavingContainer) {
        ...
        (_currentOverContainer = this.currentOverContainer.classList).remove.apply(_currentOverContainer, (0, _toConsumableArray3.default)(this.getClassNamesFor('container:over')));
      ...
      if (isOverContainer) {
        ...
        (_overContainer$classL = overContainer.classList).add.apply(_overContainer$classL, (0, _toConsumableArray3.default)(this.getClassNamesFor('container:over')));
      ...
      if (isOverDraggable) {
        ...
        (_target$classList = target.classList).add.apply(_target$classList, (0, _toConsumableArray3.default)(this.getClassNamesFor('draggable:over')));
    ...
    key: dragStop,
    value: function value(event) {
      var _source$classList2,
          _originalSource$class2,
          _originalSource$class3,
          _sourceContainer$clas2,
          _sourceContainer$clas3,
      ...
      (_source$classList2 = this.source.classList).remove.apply(_source$classList2, (0, _toConsumableArray3.default)(this.getClassNamesFor('source:dragging')));
      (_originalSource$class2 = this.originalSource.classList).remove.apply(_originalSource$class2, (0, _toConsumableArray3.default)(this.getClassNamesFor('source:original')));
      (_originalSource$class3 = this.originalSource.classList).add.apply(_originalSource$class3, (0, _toConsumableArray3.default)(this.getClassNamesFor('source:placed')));
      (_sourceContainer$clas2 = this.sourceContainer.classList).add.apply(_sourceContainer$clas2, (0, _toConsumableArray3.default)(this.getClassNamesFor('container:placed')));
      (_sourceContainer$clas3 = this.sourceContainer.classList).remove.apply(_sourceContainer$clas3, (0, _toConsumableArray3.default)(this.getClassNamesFor('container:dragging')));
      (_document$body$classL2 = document.body.classList).remove.apply(_document$body$classL2, (0, _toConsumableArray3.default)(this.getClassNamesFor('body:dragging')));
      applyUserSelect(document.body, '');

      if (this.currentOver) {
        var _currentOver$classLis2;

        (_currentOver$classLis2 = this.currentOver.classList).remove.apply(_currentOver$classLis2, (0, _toConsumableArray3.default)(this.getClassNamesFor('draggable:over')));
      }

      if (this.currentOverContainer) {
        var _currentOverContainer2;

        (_currentOverContainer2 = this.currentOverContainer.classList).remove.apply(_currentOverContainer2, (0, _toConsumableArray3.default)(this.getClassNamesFor('container:over')));
      }
      ...
      this.placedTimeoutID = setTimeout(function () {
        if (_this7.lastPlacedSource) {
          var _lastPlacedSource$cla2;

          (_lastPlacedSource$cla2 = _this7.lastPlacedSource.classList).remove.apply(_lastPlacedSource$cla2, (0, _toConsumableArray3.default)(_this7.getClassNamesFor('source:placed')));
        }

        if (_this7.lastPlacedContainer) {
          var _lastPlacedContainer$2;

          (_lastPlacedContainer$2 = _this7.lastPlacedContainer.classList).remove.apply(_lastPlacedContainer$2, (0, _toConsumableArray3.default)(_this7.getClassNamesFor('container:placed')));
        }
...
var _Emitter = __webpack_require__(246);
...
var _Droppable = __webpack_require__(249);
...
var _Draggable2 = __webpack_require__(51);
  ...
  (0, _createClass3.default)(Droppable, [{
    ...
    value: function value(event) {
      ...
      try {
        for (var _iterator = this.dropzones[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          (_dropzoneElement$clas = dropzoneElement.classList).add.apply(_dropzoneElement$clas, (0, _toConsumableArray3.default)(this.getClassNamesFor('droppable:active')));
        }
      } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
    ...
    value: function value(event) {
      ...
      try {
        for (var _iterator2 = this.dropzones[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          (_dropzone$classList = dropzone.classList).remove.apply(_dropzone$classList, (0, _toConsumableArray3.default)(this.getClassNamesFor('droppable:active')));
        }
      } catch (err) {
        _didIteratorError2 = true;
        _iteratorError2 = err;
      ...
      if (this.lastDropzone && this.lastDropzone !== this.initialDropzone) {
        var _initialDropzone$clas;

        (_initialDropzone$clas = this.initialDropzone.classList).remove.apply(_initialDropzone$clas, (0, _toConsumableArray3.default)(occupiedClasses));
      }
    ...
    value: function value(event, dropzone) {
      ...
      if (this.lastDropzone) {
        var _lastDropzone$classLi;

        (_lastDropzone$classLi = this.lastDropzone.classList).remove.apply(_lastDropzone$classLi, (0, _toConsumableArray3.default)(occupiedClasses));
      }

      dropzone.appendChild(event.source);
      (_dropzone$classList2 = dropzone.classList).add.apply(_dropzone$classList2, (0, _toConsumableArray3.default)(occupiedClasses));
    ...
    value: function value(event) {
      ...
      (_lastDropzone$classLi2 = this.lastDropzone.classList).remove.apply(_lastDropzone$classLi2, (0, _toConsumableArray3.default)(this.getClassNamesFor('droppable:occupied')));
    }
...
var _Swappable = __webpack_require__(258);
...
var _Sortable = __webpack_require__(261);
...
var Sortable = function (_Draggable) {
  ...
  (0, _createClass3.default)(Sortable, [{
    ...
    value: function getSortableElementsForContainer(container) {
      ...
      return [].concat((0, _toConsumableArray3.default)(allSortableElements)).filter(function (childElement) {
